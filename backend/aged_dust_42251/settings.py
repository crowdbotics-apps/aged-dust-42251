"""
Django settings for aged_dust_42251 project.
...
ROOT_URLCONF = 'aged_dust_42251.urls'
...
WSGI_APPLICATION = 'aged_dust_42251.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_dust_42251 API",
    "DESCRIPTION": "API documentation for aged_dust_42251 App",
    "VERSION": "v1",
}
